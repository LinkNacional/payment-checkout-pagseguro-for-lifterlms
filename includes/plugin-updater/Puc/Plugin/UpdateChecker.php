...
if ( ! class_exists('Lkn_Puc_UpdateChecker', false) ) {
    abstract class Lkn_Puc_UpdateChecker {
         ...
         */
        final public function removeHooks(): void {
         ...
         * @return bool
         */
        final public function allowMetadataHost($allow, $host) {
         ...
         * @return Lkn_Puc_InstalledPackage
         */
        final public function getInstalledPackage() {
            return $this->package;
        }
         ...
         */
        final public function checkForUpdates() {
         ...
         */
        final public function getUpdateState() {
         ...
         */
        final public function getInstalledVersion() {
         ...
         * @return string
         */
        final public function getAbsoluteDirectoryPath() {
         ...
         * @param int $errorType
         */
        final public function triggerError($message, $errorType): void {
         ...
         * @return string
         */
        final public function getUniqueName($baseTag) {
            $name = 'puc_' . $baseTag;
            if ( '' !== $this->filterSuffix ) {
         ...
         */
        final public function collectApiErrors($error, $httpResponse = null, $url = null, $slug = null): void {
         ...
         * @return array
         */
        final public function getLastRequestApiErrors() {
         ...
         */
        final public function addFilter($tag, $callback, $priority = 10, $acceptedArgs = 1): void {
         ...
         */
        final public function injectUpdate($updates) {
         ...
         * @return stdClass
         */
        final public function injectTranslationUpdates($updates) {
         ...
         * @return array
         */
        final public function getTranslationUpdates() {
         ...
         */
        final public function clearCachedTranslationUpdates(): void {
         ...
         */
        final public function fixDirectoryName($source, $remoteSource, $upgrader) {
