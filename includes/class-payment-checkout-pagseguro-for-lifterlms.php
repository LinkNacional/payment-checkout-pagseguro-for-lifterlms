 ...
 */
class Payment_Checkout_Pagseguro_For_Lifterlms {
	...
	public function __construct() {
		if ( defined( 'PAYMENT_CHECKOUT_PAGSEGURO_FOR_LIFTERLMS_VERSION' ) ) {
			$this->version = PAYMENT_CHECKOUT_PAGSEGURO_FOR_LIFTERLMS_VERSION;
		} else {
			$this->version = '1.0.0';
		}
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-payment-checkout-pagseguro-for-lifterlms-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-payment-checkout-pagseguro-for-lifterlms-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-payment-checkout-pagseguro-for-lifterlms-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-payment-checkout-pagseguro-for-lifterlms-public.php';
